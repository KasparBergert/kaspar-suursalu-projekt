...
const visibleFeedModel = computed<QuestionListModel>(() => ({
    ...
    emptyText: isSearching.value ? 'No questions matched your search.' : questionStore.feedModel.value.emptyText,
    isLoading: isSearching.value ? search.isLoading.value : questionStore.feedModel.value.isLoading,
    questions: isSearching.value ? search.questions.value : questionStore.feedModel.value.questions,
